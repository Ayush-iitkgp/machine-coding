...
Uses an Ollama-hosted model via the OpenAI-compatible chat completions API.
"""
...
# Default to a small model that fits on low-memory machines.
OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "qwen2.5:0.5b")


async def generate_answer(prompt: str) -> str:
  """Call the Ollama chat API with the given prompt."""
